        ...
        <div class="product-content row">
            ...
            <div class="product-content-right">
                 <div class="product-content-right-product-name">
                    <h1>XE ĐẠP TRẺ EM ĐẸP NHẤT VIỆT NAM</h1>
                    <P>MSP:121212</P>
                 </div>
                 ...
                 <div class="product-content-right-product-color">
                    <p><span style="font-weight: bold;">MÀU SẮC</span>:Màu Hồng Nam Tính <span style="color: red;">*</span></p>
                 ...
                 <div class="product-content-right-product-icon">
                    ...
                    <div class="product-content-right-product-icon-item">
                        <i class="fa fa-weixin"></i><p>commnet</p>

                    </div>
                    <div class="product-content-right-product-icon-item">
                        <i class="material-icons" style="font-size:36px">drafts</i><p>mail</p>
