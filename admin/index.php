    ...
    switch ($_GET['act']) {
        ...
        case "suasp":
            ...
            if (isset($_POST["submit"])) {
                ...
                $insertsp = $product->updatesp($product_id, $product_name, $product_gia,$images, $product_mota, $soluong, $masp, $color,$cartegory_id);
            }
        ...
        case "suatt":
            ...
            if (isset($_POST["submit"])) {
                ...
                $cartt->updatedh($cart_bill, $trangthai_id);
                echo '<script>window.location.href = "index.php?act=dsdonhang";</script>';
                exit;
            }
        ...
        case "xoatt":
            if (!isset($_GET["id_bill"]) || ($_GET["id_bill"]) == null) {
                ...
                $cart_bill = $_GET["id_bill"];
            }
            $delete_donhang = $cartt->deletedonhang($cart_bill);
            echo '<script>window.location.href = "index.php?act=dsdonhang";</script>';
            include "./donhang/dsdonhang";
            break;
        default:
            include "";
            break;
